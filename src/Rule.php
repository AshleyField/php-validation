...
use mightygraphics\Validation\MissingRequiredParameterException;
...
abstract class Rule
{
    ...
    /** @var \mightygraphics\Validation\Attribute|null */
    protected $attribute;
     ...
     *
     * @param array $params
     * @return \mightygraphics\Validation\Rule
     */
     ...
     * @param array $params
     * @return void
     * @throws \mightygraphics\Validation\MissingRequiredParameterException
     */

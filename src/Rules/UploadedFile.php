    ...
    public function check($value): bool
    {
        ...
        if ($minSize) {
            ...
            if ($value['size'] < $bytesMinSize) {
                $this->setMessage(':attribute file is too small, minimum size is :min_size');
                return false;
            }
        }
        ...
        if ($maxSize) {
            ...
            if ($value['size'] > $bytesMaxSize) {
                $this->setMessage(':attribute file is too large, maximum size is :max_size');
                return false;
            }
        }
        ...
        if (!empty($allowedTypes)) {
            ...
            if (!in_array($ext, $allowedTypes)) {
                $this->setMessage(':attribute file type must be :allowed_types');
                return false;
            }
        }
